...
class autismtodayofficial_widget extends WP_Widget
{
  ...
  {
    parent::__construct(
      'autismtodayofficial_widget', // Base ID
      'autismtodayofficial_widget', // Name
      array('description' => __('autismtodayofficial_widget', 'text_domain'),) // Args
    );
  }
...
//register the widget
add_action('widgets_init', 'autismtodayofficial_widget_areas');

if (!function_exists('autismtodayofficial_widget_areas')) {

  /** Initializes themes widgets.*/
  function autismtodayofficial_widget_areas()
  {
    ...
    register_sidebar(
      array(
        'name'          => __('Upper footer', 'autismtodayofficial'),
        'id'            => 'upper-footer-logo',
        'description'   => __('Logo for Autism Today', 'autismtodayofficial'),
    ...
    register_sidebar(
      array(
        'name'          => __('Mid left footer', 'autismtodayofficial'),
        'id'            => 'mid-footer-col-one',
        'description'   => __('3 main pillars', 'autismtodayofficial'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
    ...
    register_sidebar(
      array(
        'name'          => __('Mid second footer', 'autismtodayofficial'),
        'id'            => 'mid-footer-col-two',
        'description'   => __('Promos', 'autismtodayofficial'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
    ...
    register_sidebar(
      array(
        'name'          => __('Mid third footer', 'autismtodayofficial'),
        'id'            => 'mid-footer-col-three',
        'description'   => __('About', 'autismtodayofficial'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
    ...
    register_sidebar(
      array(
        'name'          => __('Mid right footer', 'autismtodayofficial'),
        'id'            => 'mid-footer-col-four',
        'description'   => __('Privacy', 'autismtodayofficial'),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
