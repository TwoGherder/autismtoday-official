		...
		<div class="bottom-footer">
			<div class="soc-med">
				...
				<ul>
					...
					<!-- tiktok -->
					<li>
						<a href="https://www.tiktok.com/@autismtodayfoundation" target="_blank"><svg aria-hidden="true" focusable="false" "data-prefix=" fab"width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xml:space="preserve">
